import { Wind, Sparkles, Leaf, MapPin, ArrowUpRight, Droplets, Eye, ChevronRight } from "lucide-react";
...
export function SmartWidget({ city, aqi, aqiLevel, suggestedRemedy }: SmartWidgetProps) {
  const now     = new Date();
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <EnvRow icon={Droplets} label="Độ ẩm"  value="72%"      color="#67e8f9" />
        <div className="divider" />
        <EnvRow icon={Wind}     label="Gió"    value="12 km/h"   color={emerald.light} />
        <div className="divider" />
        <EnvRow icon={Eye}      label="Tầm nhìn" value="8 km"   color={T.p28} />
      </div>
