    ...
    >
      ...
      <div className="h-[200px] sm:h-[240px] flex flex-col relative z-10">
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          <p className="font-display text-3xl sm:text-4xl lg:text-6xl font-bold text-white tracking-tighter group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-white group-hover:to-emerald-200 transition-all duration-500 leading-none truncate max-w-full">
